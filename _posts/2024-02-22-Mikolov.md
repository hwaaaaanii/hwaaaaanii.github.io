...
![No image](/assets/img/Distributed Representations of Words and Phrases and their Compositionality/Distributed Representations of Words and Phrases and their Compositionality3.png)
...
![No image](/assets/img/Distributed Representations of Words and Phrases and their Compositionality/Distributed Representations of Words and Phrases and their Compositionality4.png)
...
### 3-1. Subsampling method of Frequent Words
 ...
 Corpora(말뭉치 - 데이터)가 매우 클 때에는 ‘in’, ‘the’, ‘a’ 와 같이 큰 정보를 담고 있지 않은 단어들이 압도적으로 높은 빈도를 갖게 됩니다. 이에 착안하여, 빈도가 높은 단어에는 확률 값을 낮게 주고, 빈도가 낮은 단어에는 확률 값을 높게 줌으로 단어들을 효율적으로 Sampling할 수 있게 해줍니다.
...
![No image](/assets/img/Distributed Representations of Words and Phrases and their Compositionality/Distributed Representations of Words and Phrases and their Compositionality1.png)

![No image](/assets/img/Distributed Representations of Words and Phrases and their Compositionality/Distributed Representations of Words and Phrases and their Compositionality2.png)

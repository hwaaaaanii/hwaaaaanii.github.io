...
와 같이 되는 함수 $F$를 Homomorphism하다고 하는데요. 쉽게 말하면, 입력으로 덧셈의 항등원을 넣어 주었을 때, (e.g $(ice-steam)^T = -(steam-ice)^T$), 함수의 출력값으로는 곱셈의 역원이 나오는 성질을 말합니다. 함수 $F$가 Homomorphism하다고 설정을 해주면, $F$는  $(R,+)$를 $(R_{>0}, X)$ mapping할 수 있는 함수가 되며, 다음과 같이 식에 조작을 가할 수 있습니다.
...
$$
=> F(w_{i}^T \tilde{w}_k) = F((w_{i} - w_{j})^T \tilde{w}_k )* F(w_{j}^T \tilde{w}_k) 
$$
...
<div style="text-align: center;">
  <img src="/assets/img/2/2.png" alt="Image 3" style="width:40%;">
</div>
...
<div style="display:flex; justify-content:space-around; align-items:center;">
  <img src="/assets/img/2/3.png" alt="Image 3" style="width:90%;" />
  <img src="/assets/img/2/4.png" alt="Image 4" style="width:90%;" />
</div>

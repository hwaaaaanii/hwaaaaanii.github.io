...
논문에서는 BERT를 활용하여 Encoder와 Decoder를 구성해, 각각의 Model을 학습하여 성능을 평가했습니다. 두 Model은 task과 data set에 따라서 성능이 달라졌고, 논문에서 각 모델의 장단점과 적합한 사용 사례를 제시하여 연구자들이 자신의 필요에 맞는 최적의 모델을 선택할 수 있도록 소개했습니다. 
...
2. Retrieved Document의 위치 또한 성능에 영향을 미친다는 것을 발견했습니다. 
3. Gold Document가 Query의 근처에 놓이는 것이 좋다는 것을 발견했습니다.

위의 발견들을 통해 RAG System을 활용하기 위한 새로운 지평을 열었다고 생각합니다.
